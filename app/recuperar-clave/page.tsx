...
export default function RecoverPasswordPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSent(true);
      router.push(`/restablecer-clave?email=${encodeURIComponent(email.trim().toLowerCase())}`);
    } catch {
