...
export default function OperationsHubModulePage() {
  return (
    <WamaModuleLanding
      eyebrow="Operations Hub"
      title="Controla alertas, casos y responsables."
      subtitle="Gestión operativa diaria con trazabilidad y evidencia."
      description="Operations Hub permite registrar alertas, asignar responsables, controlar SLA, adjuntar evidencias y mantener visibilidad sobre lo que ocurre en terreno."
      primaryCta="Probar Operations Hub"
      ...
      guideDescription="En Operations Hub, WAMA funciona como apoyo para revisar alertas, detectar casos atrasados, orientar responsables y ordenar prioridades."
      guidePrompts={[
