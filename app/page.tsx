  ...
  return (
    <WamaShell>
      <main className="overflow-hidden bg-white text-[#0B0C0E]">
        <section className="relative overflow-hidden bg-[#0B0C0E] text-white">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-6 sm:py-20 lg:min-h-[calc(100vh-5rem)] lg:grid-cols-[1.08fr_0.92fr] lg:items-end lg:py-28">
            <div>
              ...
              <h1 className="mt-5 max-w-5xl text-[2.65rem] font-black leading-[0.96] tracking-[-0.065em] sm:mt-7 sm:text-6xl md:text-7xl">
                Gestiona tu empresa módulo por módulo.
              </h1>
              <p className="mt-6 max-w-3xl text-base leading-7 text-[#B7BEC8] sm:mt-8 sm:text-lg sm:leading-8">
                Ventas y gastos en productos independientes, conectados y
                preparados para crecer junto a tu empresa.
              </p>
            ...
            <div className="hidden border-l border-white/15 pl-0 lg:block lg:pl-10">
              ...
              <h2 className="mt-5 text-3xl font-black tracking-[-0.04em]">
                Sales Hub + Expense Hub
              </h2>
              <p className="mt-4 max-w-lg text-base leading-7 text-[#AEB6C0]">
                Dos portales especializados. Una misma experiencia WAMA.
              </p>
              <Link
                href="/acceso"
        ...
        <section id="productos" className="scroll-mt-24 bg-[#E9EDF0]">
          <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-24 lg:py-32">
            <p className="text-sm font-black uppercase tracking-[0.22em] text-[#008F87]">
              Productos que muestran cómo trabajan
            </p>
            <h2 className="mt-4 max-w-5xl text-3xl font-black leading-[1.02] tracking-[-0.05em] sm:mt-5 sm:text-4xl md:text-6xl">
              No solo mires el software. Recorre el proceso completo.
            </h2>
            <p className="mt-4 max-w-3xl text-base leading-7 text-[#66707C] sm:mt-6 sm:text-lg sm:leading-8">
              Cada Hub cuenta una historia distinta: desde la primera acción del
              usuario hasta la decisión final de la empresa.
            </p>

            <div className="mt-9 space-y-8 sm:mt-16 sm:space-y-12">
              <ProductStory
                eyebrow="WAMA Expense Hub"
                title="De una foto tomada con el celular a un gasto aprobado y controlado."
                description="Captura, lectura inteligente, confirmación, aprobación y control financiero en una sola experiencia."
                href="/acceso/expense-hub"
                action="Entrar al portal Expense"
                kind="expense"
              />
              <ProductStory
                eyebrow="WAMA Sales"
                title="De un prospecto nuevo a una oportunidad cerrada con seguimiento real."
                description="Clientes, actividades, propuestas, negociación y resultados comerciales conectados en un único flujo."
                href="/acceso/sales-hub"
                action="Entrar al portal Sales"
                kind="sales"
                reverse
              />
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
            ...
            <div className="mt-14 divide-y divide-[#DDE1E6] border-y border-[#DDE1E6]">
              ...
              <ModuleRow
                ...
                description="Rinde, aprueba y controla gastos desde celular, tablet o computador."
        ...
        <section
          id="contacto"
          className="border-y border-[#DDE1E6] bg-[#F5F6F7]"
        >
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:py-24">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-black leading-[1.04] tracking-[-0.055em] md:text-6xl">
                Conversemos sobre el módulo que necesita tu empresa.
              </h2>
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#66707C]">
                Envía tus consultas al correo{" "}
                <strong>contacto@wamaapp.com</strong>. También puedes
                escribirnos para solicitar una demostración o recibir soporte
                comercial.
              </p>
              <a
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <ShareCard
                ...
                href="mailto:contacto@wamaapp.com?subject=Quiero%20una%20demostraci%C3%B3n%20de%20WAMA&body=Hola%2C%20quiero%20conocer%20WAMA%20para%20mi%20empresa."
              />
              <ShareCard
                title="WhatsApp"
                text="Compartir WAMA"
                href="https://wa.me/?text=Conoce%20WAMA%2C%20software%20modular%20para%20empresas%3A%20https%3A%2F%2Fwww.wamaapp.com"
                external
              />
              <ShareCard
                title="LinkedIn"
                text="Publicar en tu red"
                href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fwww.wamaapp.com"
                external
              />
            </div>
          </div>
        ...
        <section className="bg-[#0B0C0E] text-white">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
            <h2 className="max-w-5xl text-5xl font-black leading-[1] tracking-[-0.06em] md:text-7xl">
              Elige tu producto y comienza a trabajar.
            </h2>
    ...
    <article className="min-w-0 overflow-hidden rounded-[1.75rem] border border-[#D2D8DE] bg-white shadow-[0_20px_65px_rgba(11,12,14,0.10)] sm:rounded-[2.25rem]">
      <div className="grid gap-6 border-b border-[#E3E7EA] px-5 py-7 sm:px-8 sm:py-9 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:px-10">
        <div className="min-w-0">
          ...
          <h3 className="mt-4 max-w-5xl text-[2.2rem] font-black leading-[1.02] tracking-[-0.055em] sm:text-4xl lg:text-5xl">
            {title}
          </h3>
          <p className="mt-4 max-w-3xl text-base leading-7 text-[#69717D]">
            {description}
          </p>
        </div>
        <Link
          href={href}
          className="inline-flex w-full items-center justify-center rounded-full bg-[#00E5D6] px-7 py-4 text-sm font-black text-[#0B0C0E] transition hover:-translate-y-0.5 lg:w-auto"
        >
          {action} →
        </Link>
      </div>
...
function ShareCard({
  ...
  return (
    <a
      ...
      className="rounded-3xl border border-[#D6DCE1] bg-white p-6 transition hover:-translate-y-1 hover:border-[#00BDB2]"
    >
