  ...
  return (
    <WamaShell>
      <main className="overflow-hidden bg-white text-[#0B0C0E]">
        ...
        <section id="contacto" className="border-t border-[#DDE1E6] bg-[#F5F6F7]">
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1fr_auto] lg:items-center lg:py-24">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.22em] text-[#008F87]">Conversemos</p>
              <h2 className="mt-4 max-w-3xl text-4xl font-black leading-tight tracking-[-0.055em] md:text-6xl">¿Quieres implementar WAMA en tu empresa?</h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#66707C]">
                Envía tus consultas al correo <a href="mailto:contacto@wamaapp.com" className="font-black text-[#0B0C0E] underline decoration-[#00E5D6] decoration-2 underline-offset-4">contacto@wamaapp.com</a> y te ayudaremos a elegir el módulo adecuado.
              </p>
            </div>
            <a
              href="mailto:contacto@wamaapp.com?subject=Consulta%20comercial%20WAMA"
              className="inline-flex w-full items-center justify-center rounded-full bg-[#0B0C0E] px-8 py-4 text-sm font-black !text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-[#202328] lg:w-auto"
            >
        ...
        <section className="bg-[#0B0C0E] text-white">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row"><Link href="/acceso" className="inline-flex items-center justify-center rounded-full bg-[#00E5D6] px-8 py-4 text-sm font-black text-[#0B0C0E]">Acceder a los portales</Link><Link href="/trial" className="inline-flex items-center justify-center rounded-full border border-white/20 px-8 py-4 text-sm font-black text-white">Prueba gratis 15 días</Link></div>
          </div>
        </section>
      </main>
    </WamaShell>
