...
-- El owner empresarial se representa como module_admin dentro de cada modulo.
-- Ese valor ya pertenece al catalogo historico de roles y evita modificar las
-- restricciones compartidas por Sales Hub y Expense Hub.
