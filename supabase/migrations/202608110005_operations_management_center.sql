-- Centro de administración real de Operations Hub.
-- Idempotente: puede ejecutarse aunque la migración 202608110004 ya haya sido aplicada.
begin;
...
alter table public.wama_invitations drop constraint if exists wama_invitations_status_check;
alter table public.wama_invitations add constraint wama_invitations_status_check
