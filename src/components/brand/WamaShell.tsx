...
import { Download, Home, Layers3, LogIn, Menu, X } from "lucide-react";
        ...
        {open && (
          <div className="border-t border-white/10 bg-[#0B0C0E] px-4 py-4 md:hidden">
            <div className="mx-auto grid max-w-md gap-2">
              ...
              <Link href="/trial" onClick={() => setOpen(false)} className="mt-1 rounded-2xl bg-[#00E5D6] px-4 py-3 text-center text-sm font-black text-[#0B0C0E]">Prueba gratis 14 días</Link>
            </div>
          </div>
        )}
      </header>
